...
else if(1680==clientWidth){
	imageWidth = 1100,
	imageHeight = 650;
}
else if(1600==clientWidth){
	imageWidth = 1100,
	imageHeight = 640;
}
else if(1583==clientWidth){
	imageWidth = 1100,
	imageHeight = 550;
	$("#container").height(550);
}
else if(1440==clientWidth){
	imageWidth = 1000,
	imageHeight = 500;
}
else if(1366<clientWidth<1439){
	imageWidth = 1000,
	imageHeight = 430;
}else{
	imageWidth = 900,
...
window.onload = function() {
    ...
    var urls = [
            contextPath+'/images/HP-A_RE1.jpg',
            contextPath+'/images/HP-A_RE2.jpg',
            contextPath+'/images/HP-A_RE3.jpg',
            contextPath+'/images/HP-A_RE4.jpg'
        ],
        image,
        loaded = 0;
...
jQuery(function(){
	$("#service").hover(function(){
		$(".service").toggleClass("_hide");
	});
	$("#wallet").hover(function(){
		$(".wallet").toggleClass("_hide");
	});
});